...
function () {
  function Upload(file, options) {
    ...
    defineProperty(this, "handleSuccess", function (result) {
      _this.handleChangeFile({
        state: 'finished',
        id: _this.id,
        file: _this.directUpload.file
      ...
      var promise = new Promise(function (resolve, reject) {
        _this2.directUpload.create(function (error, attributes) {
          if (error) reject(error);else {
            var result = _this2.options.fullAttributes ? attributes : attributes.signed_id;
            resolve(result);
          }
        });
      });
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              resultArr = _context2.sent;

              _this.props.onSuccess(resultArr);
  ...
  createClass(DirectUploadProvider, [{
    ...
    value: function _createUpload(file) {
      var _this$props = this.props,
          ...
          fullAttributes = _this$props.fullAttributes;
